...
class TrySerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        event = Event.objects.get(id=event_id)
        student = Student.objects.get(user__user__username = student_username)
        ...
        try_object = Try.objects.create(event_reg=event_reg,**validated_data)
        return try_object
...
class LeaderboardSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance):
        ...
        if instance.event_type == event_type_constants.DISTANCE:
            ret = EventRegistration.objects.filter(
